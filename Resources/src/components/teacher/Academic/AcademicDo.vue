        ...
        <div v-for="data in datas">
            ...
            <div v-for="PaperConfLn in data.resRandomPaperConfLn">
                ...
                <div class="AcadeQuestion" v-for="(question,index) in PaperConfLn.questions">
                    <label class="labelWord"></label>
                    <div class="AcadeQuestionTitle" v-for="List in question.list" v-if="List.questionType === '01' " >
                        <label class="labelWord0" v-if="PaperConfLn.selectAble === '1'">{{++index}}、</label>
                        <label class="labelWord1" v-if="PaperConfLn.selectAble === '0'">{{++index+25}}、</label>
                        <span  v-html="List.content.replace('【题干】','')"></span>
...
//            异步获取
            ...
            this.$http.post('/web/teacher/modeltest/bulidPaper', parmas).then((response) => {
                ...
                console.log(data)
                let Dtrue = data.retData.resRandomPaperQuestion
                this.datas = Dtrue
