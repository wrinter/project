<template>
  <div class="c_Main" >
    <div v-if="workList.length>0" class="c_workList">
      <ul class="workList correctList" id="workList">
        <li class="listLi" v-for="temp in workList" :id="temp.id">
          <ul class="workList">
            <li class="assignTime">
    ...
    <div class="h_nodata" id="NoData" v-else>
    ...
    <v-pages :ToPages="ThisPages" @ListenChild="RecieveChild" v-if="workList.length>0"></v-pages>
    ...
    methods: {
      ...
      toCorrect (id, num) {
        if (num === 0) {
          ...
          this.$router.push('/content/teacher/homework/correctwork?id=' + id)
        }
      }
    },
    components:{
...
<style>
  ...
  @media screen and (min-width: 1600px) {
    ...
    .listLi .workList li .submitWork {
      overflow: hidden;
      height: 48px;
      line-height: 48px;
    }

    .listLi .workList li .submitWork ._name {
      float: left;
      margin-right: 10px;
      height: 43px;
      line-height: 43px;
    ...
    .listLi .workList li .correctWork {
      overflow: hidden;
      height: 43px;
      line-height: 43px;
    }

    .listLi .workList li .correctWork ._name {
      float: left;
      margin-right: 10px;
      height: 43px;
      line-height: 43px;
  ...
  /*add 2017-5-11*/
  .workList li.Title{text-align: left;}
</style>
