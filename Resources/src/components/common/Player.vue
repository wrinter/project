...
<script>
  import {SupportAgent} from '../../common/js/ComPhone.js'
  export default {
    // 用于接收来自父组件的数据
    props: {
      Tosrc: String
...
<style>
  ...
  .Com_Pause{float: left;  width: 30px;  height: 30px;  margin: 15px 10px 0 40px;  overflow: hidden;  cursor: pointer;background: url("/static/common/images/player1.3/new_play0.png")0 0 no-repeat;background-size: 100%;}
  .Com_Play{float: left;  width: 30px;  height: 30px;  margin: 15px 10px 0 40px;  overflow: hidden;  cursor: pointer;background: url("/static/common/images/player1.3/new_play1.png")0 0 no-repeat;background-size: 100%;}
  ...
  .TeCom_Player .Com_BarLoad {background-color:#65b113;}
  .StuCom_Player .Com_BarLoad {background-color:#49b9df;}
  ...
  .Com_NoMal{float: left;margin-right: 7px;overflow: hidden;margin-top: 22px; cursor: pointer; width: 30px;height: 22px;background: url("/static/common/images/player1.3/new_voice0.png") 0 0 no-repeat;}
  .Com_Mute{float: left;margin-right: 7px;overflow: hidden;margin-top: 22px; cursor: pointer; width: 30px;height: 22px;background: url("/static/common/images/player1.3/new_voice1.png") 0 0 no-repeat;}
  ...
  .TeCom_Player .Com_Adjust > p {background-color:#65b113;}
  .StuCom_Player .Com_Adjust > p {background-color:#49b9df;}
  @media screen and (max-width:780px){
   .TeCom_Player,.StuCom_Player{width: 100%;height: 1.5rem;background: white;border-top: 1px solid #ccc;}
   .Com_Pause,.Com_Play{margin:0.25rem 0.5rem ;width: 1rem;height: 1rem; }
   .Com_Pause{background: url("/static/common/images/player1.3/p_playico0.png")0 0 no-repeat;background-size: 100%;}
   .Com_Play{background: url("/static/common/images/player1.3/p_palyico1.png")0 0 no-repeat;background-size: 100%;}
   .Com_Bar{width: 5rem;height: 0.4rem;margin: 0.55rem 0 0 0; border-radius: 0.2rem;background-color: #F6F6F6;border-top: 1px solid #ccc;box-sizing: border-box;}
   .Com_BarLoad{border-radius: 0.2rem;background: #58C1E4;}
   .Com_Duration,.Com_Cut,.Com_Current{color: #333;font-size: 0.35rem;line-height: 1.5rem;}
   .Com_Current{color:#58C1E4;}
   .Com_Volume{display: none;}
 }
</style>
