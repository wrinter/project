<template>
  <div v-if="showcrumbs" :class="{'TeacherCrumbs':ToItem==0,'StudentCrumbs':ToItem==1}">
    <ul class="CrumbList">
...
<style>
  .TeacherCrumbs,.StudentCrumbs{float: left;width: 100%;overflow: hidden;box-sizing: border-box; background: white;height: 50px;border-bottom: 1px solid #ccc;}
  ...
  .TeacherCrumbs .CrumbList>li:last-child{color: #65b113;}
  .StudentCrumbs .CrumbList>li:last-child{color: #49b9df;}
