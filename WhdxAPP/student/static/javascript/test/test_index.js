...
function SelectOption(AllData){
    ...
    for(var j=0;j<AllData.length;j++){
        ...
        if(scoreDef!=null&&scoreDef!=""){
            $Select+='<p class="r_OptionTitle">'+AllData[j].lineName+scoreDef+'</p>';
        }else{
...
function CoverBtn(data){
    ...
    if(data==-1){
        ...
        Result='<p class="r_CoverBtn CreatCover"  data-status="'+data+'">补偿训练</p><p class="LineT" id="LineT"></p>';
    }
    else if(data==1){
        Result='<p class="r_CoverBtn GoCover"  data-status="'+data+'">补偿训练</p><p class="LineT" id="LineT">已购买</p>';
    }
    else if(data==2){
        Result='<p class="r_CoverBtn"  data-status="'+data+'">补偿训练</p><p class="LineT" id="LineT">已购买</p>';
    }
    else {
        Result='<p class="r_CoverBtn"  data-status="'+data+'">补偿训练</p><p class="LineT"  id="LineT">已购买</p>';
    }
