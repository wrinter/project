...
function CoverBtn(data){
    ...
    if(data.status==-1){
        ...
        Result='<p class="r_CoverBtn"  data-status="'+data.status+'">补偿训练</p><p class="LineT">提交</p>';
    }
    else {
        Result='<p class="r_CoverBtn"  data-status="'+data.status+'">补偿训练</p><p class="LineT">批改</p>';
    }
    return Result;
};
//补偿按钮状态
