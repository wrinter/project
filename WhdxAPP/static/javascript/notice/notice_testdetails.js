...
//    公共
    var average = JSON.parse(sessionStorage.getItem("average"));
    var subjectname = JSON.parse(sessionStorage.getItem("subjectname"));
    javascript:bc.setAverage(average);//和安卓手机的交互
    javascript:bc.setChapterTitle(subjectname);//和安卓手机的交互
    //学生详情
    ...
    function Students (){
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                var n_details_socre = $(".n_details_socre");
                if(data.retCode == "0000"){
                    for(var i = 0 ;i<data.retData.length;i++){
                        ...
                        if(score == "--"){
                            newclone.find(".n_details_socre").text("--分");
                        }else{
                            newclone.find(".n_details_socre").text(score+"分");
                        }
...
//    题目详情
    ...
    function Title (){
        var SubData={};
        SubData.paperAssignId=Request.ThispaperAssignId;
