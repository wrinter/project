    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                var BoxHtml='';
                BoxHtml+='<div class="AreaBox">';
                BoxHtml+='<div class="area_ctrl">';
                BoxHtml+='<div class="area_roll_mask">';
                BoxHtml+='<div class="area_roll">';
                BoxHtml+='<div>';
                BoxHtml+='<div class="gear area_province" data-areatype="area_province"></div>';
                BoxHtml+='<div class="area_grid">';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='<div>';
                BoxHtml+='<div class="gear area_city" data-areatype="area_city"></div>';
                BoxHtml+='<div class="area_grid">';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='<div>';
                BoxHtml+='<div class="gear area_county" data-areatype="area_county"></div>';
                BoxHtml+='<div class="area_grid">';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                BoxHtml+='<div class="area_btn_box">';
                BoxHtml+='<div class="area_btn larea_cancel">取消</div>';
                BoxHtml+='<div class="area_btn larea_finish">确定</div>';
                BoxHtml+='</div>';
                BoxHtml+='</div>';
                _self.gearArea.innerHTML =BoxHtml;
        ...
        finish: function(e) {
            ...
            _self.trigger.setAttribute("data-provinceId", provinceCode);
            _self.trigger.setAttribute("data-city", ((cityText)?('' + cityText):('')));
            _self.trigger.setAttribute("data-cityId", ((cityCode)?('' + cityCode):('')));
            _self.trigger.setAttribute("data-county", ((countyText)?('' + countyText):('')));
            _self.trigger.setAttribute("data-countyId", ((countyCode)?('' + countyCode):('')));
            //自定义存放位置
            ...
            AllAdress.innerHTML='';
            Provice.innerHTML=provinceText;
            Provice.setAttribute("data-Id", provinceCode);
            City.innerHTML=((cityText)?('' + cityText):(''));
            City.setAttribute("data-Id", ((cityCode)?('' + cityCode):('')));
            Contry.innerHTML=((countyText)?('' + countyText):(''));
            Contry.setAttribute("data-Id", ((countyCode)?('' + countyCode):('')));
