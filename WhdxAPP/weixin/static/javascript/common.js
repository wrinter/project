...
function intMathJax(subjectId) {
    ...
    if(oldLatexScript){
        ...
        if(subjectId){
            if(subjectId == "01" || subjectId == "06" || subjectId == "07" || subjectId == "08" || subjectId == "09"){
                var latexStyle = document.createElement("style"),
                    latexScript = document.createElement("script"),
                    intLatex = latexScript.cloneNode(false);
                latexScript.setAttribute("src","https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_CHTML");
                ...
                latexStyle.innerHTML = ".MathJax{font-family: Arial, Chandara;}.MathJax span{line-height: normal !important;}";
