...
var ThisVue = new Vue({
    ...
    methods: {
        ...
        ChangeArt: function (rule) {
            ...
            window.location.href = 'comart.html?id=' + this.ReceiveData[this.ArtIndex].id + '&index=' + this.ArtIndex;
        },
        Command: function () {
...
//# sourceMappingURL=comart-compiled.js.map