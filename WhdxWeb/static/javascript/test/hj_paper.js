...
function sSubject(){
    if(thisSt&&thisSt!='2'&&thisTarget == "mylist"){
...
function sPaperinfo(data){
    ...
    if(thisSt!='2'&&thisTarget == "mylist"){
        ...
        $H.class("exercise_btn_in")[0].innerHTML = thisPt == "105" || thisPt == "115" || thisPt == "202" || thisPt == "212" || thisPt == "203" || thisPt == "213" ? "<input id='w_PrintBtn' class='exercise_btn_print' type='button' value='打印'><a class='exercise_btn_publish' href='javascript:;' title='布置'>布置</a>" : "<input id='w_PrintBtn' class='exercise_btn_print' type='button' value='打印'><a class='exercise_btn_edit' href='../../model/test/hj_edit.html' title='编辑'>编辑</a><a class='exercise_btn_publish' href='javascript:;' title='布置'>布置</a>";
    }
    ...
    if(thisSubject == "03" && (thisPt == "102" || thisPt == "103" || thisPt == "104" || thisPt == "112" || thisPt == "113" || thisPt == "114" || thisPt == "203" || thisPt == "213")){//03:英语 && 分层作业/听力训练
        if(thisPt == "203" || thisPt == "213"){
            ...
            $H.components.clickUpError(".work_box");//报错
        }else{
