...
function RefactorData(data){
    ...
    var Correct=data.errorRate;//正确率
    var CorrectPro=data.correctProportion;//正确率
    // $BasicKnowledge=CreatBasic(BasicData,CorrectPro);
...
function CreatAnlysis(data,errorRate){
    var $PreviewTest='';
    var IsThisObj=JSON.stringify(errorRate)
    if(IsThisObj!='{}'){
...
function ErroRata(Correct,data){
    ...
    var IsThisObj=JSON.stringify(Correct)
    if(IsThisObj!='{}'){
