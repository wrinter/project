                ...
                if (data[i].childrens[n].subType != 15) {
                    ...
                    for (var j = 0; j < data[i].childrens[n].childrens.length; j++) {
                        ...
                        if (titum == Is1) {
                            ...
                            $content += '<span class="c_PartTit fcE3">' + titum + '</span>';
                        }
                        else if (titum == Is3) {
                            $content += '<span class="c_PartTit fc10">' + titum + '</span>';
                        }
                        else {
                            $content += '<span class="c_PartTit fc65">' + titum + '</span>';
                        }
                        ...
                        for (var k = 0; k < data[i].childrens[n].childrens[j].resList.length; k++) {
                            $content += '<li>';
                            if (titum == Is1) {
                                $content += '<i class="guosprite c_ficico0 fl artlogo"></i>';
                            }
                            else if (titum == Is2) {
                                $content += '<i class="guosprite c_ficico1 fl artlogo"></i>';
                            }
                            else if (titum == Is3) {
                                $content += '<i class="guosprite c_ficico2 fl artlogo"></i>';
                            }
                            else {
                                $content += '<i class="guosprite c_ficico0 fl artlogo"></i>';
                            }
...
function ArtOnclick(){
    $('.c_Title0').on('click',function(){
        CreatArtArr( $(this).parents('.c_FicList').find('a'))
    });
