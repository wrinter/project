        ...
        Change : function(){
            ...
            task_details.on("click",function(){
                if(!$(this).hasClass("add")){
                    ...
                    task_studiesdetails.removeClass("add");
                    $(this).css({"background":"#59c1e4"});
                    task_studiesdetails.css({"background":"#e7e7e7"});
                }else{
            ...
            task_studiesdetails.on("click",function(){
                if(!$(this).hasClass("add")){
                    ...
                    task_details.removeClass("add");
                    $(this).css({"background":"#59c1e4"});
                    task_details.css({"background":"#e7e7e7"});
                }else{
