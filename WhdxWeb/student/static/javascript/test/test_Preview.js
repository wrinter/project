                    ...
                    success : function(data){
                        ...
                        if(data.retCode == "0000"){
                            ...
                            if(isPkComplete=="2" && isComplete=="2"){
                                ...
                                switch(result){
                                    case 0 : $(".task_meimg").find(".task_pk,.peom").show();break;//我胜
                                    case 1 : $(".task_uimg").find(".task_pk,.peom").show();break;//对方胜
                                    case 2 : $(".task_uimg,.task_meimg").find(".task_blance").show();break;//平局
                                }
                            }
                        }
                    },
