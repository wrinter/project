...
function CreatList(data){
    ...
    for(var i=0;i<data.length;i++){
        ...
        for(var j=0;j<data[i].resList.length;j++){
            $content+='<li>';
            $content+='<a target="_blank" class="a_Title" href="../../model/acrossenglish/acrossenglish_voice.html?id='+data[i].resList[j].id+'" title="'+data[i].resList[j].title+'" >';
