<template>
  <div>
    <ul class="LogBox">
      <li class="LogTitle">
        <p class="Tixt">登录</p>
        <p class="RegTxt"><router-link v-bind:to="'/login'">注册</router-link></p>
      </li>
      <li class="DefultBox">
      ...
      <li class="OtherBox">
        <p class="ModelTxt">密码</p>
        <input type="password" class="ModelInput" v-model="Pass" maxlength="16" >
        <transition name="el-fade-in">
...
<style>
  ...
  .LogBox{width: 340px;overflow: hidden;background: white;border-radius: 10px;padding: 30px 0 15px 40px;box-sizing: border-box; }
